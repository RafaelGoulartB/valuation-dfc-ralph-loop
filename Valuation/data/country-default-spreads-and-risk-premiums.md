...
| Country                        | Moody's Rating | Adj. Default Spread | Country Risk Premium | Equity Risk Premium | Corporate Tax Rate | Sovereign CDS | ERP (CDS-based) |
| ------------------------------ | -------------- | ------------------- | -------------------- | ------------------- | ------------------ | ------------- | --------------- |
...
**Referência:** https://pages.stern.nyu.edu/~adamodar/New_Home_Page/datafile/ctryprem.html
